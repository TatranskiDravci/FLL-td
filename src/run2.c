...
int main(void)
{
    ...
    // bridge
    moveColor(b, 700, cs_s, 0.0, 5.0, &ctl, FWD, NS_INI);
    moveColor(b, 700, cs_s, 100.0, 20.0, &ctl, FWD, NS_MID);
    moveColor(b, 700, cs_s, 7.0, 5.0, &ctl, FWD, NS_MID);
    moveColor(b, 700, cs_f, 0.0, 5.0, &ctl, FWD, NS_FIN);
